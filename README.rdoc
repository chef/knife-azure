...
Options used with the Create subcommand:
      ...
      option :dns_name,
        ...
        :description => "Required. The DNS prefix name that can be used to access the cloud service. For example, if the DNS of cloud service is MyService you could access the cloud service by calling: http://MyService.cloudapp.net"
