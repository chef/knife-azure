...
==== On Windows
You can decode and extract the PFX file using powershell

 powershell -command "[IO.File]::WriteAllBytes('cert_decoded.pfx',[System.Convert]::FromBase64String( (Get-Content cert.pfx) ))"

Alternatively you can use a free windows base 64 decoder such as http://www.fourmilab.ch/webtools/base64/base64.zip,
...
==== On Windows
 ...
 openssl base64 -d -A -in cert_decoded.pfx -out cert_decoded.der
