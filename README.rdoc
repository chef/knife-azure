...
Windows source images should have the WinRM service enabled and the authentication should be set accordingly(Basic, NTLM and Kerberos). Firewall rules should be added accordingly to the source images. Refer to the link below to configure this:
...
===Azure specific options
      ...
      :azure_vm_size                    Default is Small. Size of virtual machine
