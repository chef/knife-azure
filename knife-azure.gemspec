...
Gem::Specification.new do |s|
  ...
  s.add_dependency "azure_mgmt_resources", ">= 0.17.0"
  s.add_dependency "azure_mgmt_compute", ">= 0.18.0"
  s.add_dependency "azure_mgmt_storage", ">= 0.17.2"
  s.add_dependency "azure_mgmt_network", ">= 0.17.3"
